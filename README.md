...
* html_file: If defined, html output is generated and written to this file.
* pdf_file: If defined, a pdf representation of the html rendered report is generated (thereby skipping details).
* project_title: A string that is added to the report title.
