...
def testDataInClassInNamespace():
  p = testSimpleData()
  p.namespace = "n"
  p.class_name = "c"  
...
def simpleFunctionWithSimpleArgs():
  p = PropertiesTest()
  p.name = "f"
  p.full_name = "f"
...
def simpleFunctionWithTemplateArg():
  p = PropertiesTest()
  p.name = "f"
  p.full_name = "f"
...
def simpleFunctionWithTemplateArgWithBraces():
  p = PropertiesTest()
  p.name = "f"
  p.full_name = "f"
...
def getFunctionTests():
  return [
     simpleFunctionWithSimpleArgs()
     simpleFunctionWithTemplateArg()
     simpleFunctionWithTemplateArgWithBraces()
  ]
  
def testSimpleFunctions():
  getFunctionTests()
  
def testFunctionsInNamespaces():
  for test in getFunctionTests():
     test.namespace = "n"
     
def testFunctionsInClasses(self):
  for test in getFunctionTests():
     test.class_name = "c"
...
class TestSymbolRecognition(unittest.TestCase):
   ...
   def testAll(self):
      ...
      testDataInNamespace()
      testDataInClass()
      testDataInClassInNamespace()
      
      testSimpleFunctions()
      testFunctionsInNamespaces()
      testFunctionsInClasses()
      testFunctionsInClassesInNamespaces()
