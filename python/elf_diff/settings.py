...
class Settings(object):
   ...
   def setupParameters(self):
      ...
      self.parameters = [
         ...
         Parameter("old_alias", "An alias string that is supposed to be used to reference the old binary version."),
         Parameter("new_alias", "An alias string that is supposed to be used to reference the new binary version."),
         
         Parameter("old_info_file", "A text file that contains information about the old binary version."),
         Parameter("new_info_file", "A text file that contains information about the new binary version."),
         
         Parameter("build_info", "A string that contains build information that is to be added to the report.", default = ""),
         
         Parameter("bin_dir", "A place where the binutils live.", default = None),
         
         Parameter("bin_prefix", "A prefix that is added to binutils executables.", default = ""),
         ...
         Parameter("pdf_file", "The filename of the generated pdf report. (details are skipped in pdf files)."),
